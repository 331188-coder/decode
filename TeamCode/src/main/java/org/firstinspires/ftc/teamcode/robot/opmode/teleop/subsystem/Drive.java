...
public class Drive {
    ...
    public void run() {
        ...
        // Strafing -Sarv here according to my instincts i belilve this is wrong. now try sucker
        double fL = Range.clip(drive + strafe + turn,);
        double fR = Range.clip(drive + strafe - turn,);
        double bL = Range.clip(drive - strafe + turn,);
        double bR = Range.clip(drive - strafe - turn,);
